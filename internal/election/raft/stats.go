...
// IncLessCmtHeartbeatAcks counter.
func (s *Raft) IncLessCmtHeartbeatAcks() {
	atomic.AddUint64(&s.stats.LessCmtHearbeatAcks, 1)
}
...
func (s *Raft) getStats() *model.RaftStats {
	return &model.RaftStats{
		...
		LessCmtHearbeatAcks:        atomic.LoadUint64(&s.stats.LessCmtHearbeatAcks),
