...
func raftEnableCommandFn(cmd *cobra.Command, args []string) {
	...
	// send enable raft
	{
		...
		rsp, err := neorpc.EnableRaftRPC(self)
		ErrorOK(err)
		RspOK(rsp.RetCode)
...
func raftDisableCommandFn(cmd *cobra.Command, args []string) {
	...
	// send disable raft
	{
		...
		rsp, err := neorpc.DisableRaftRPC(self)
		ErrorOK(err)
		RspOK(rsp.RetCode)
...
func raftTryToLeaderCommandFn(cmd *cobra.Command, args []string) {
...

	{
		...
		rsp, err := neorpc.TryToLeaderRPC(self)
		ErrorOK(err)
		RspOK(rsp.RetCode)
...
func raftStatusCommandFn(cmd *cobra.Command, args []string) {
	...
	state, nodes, err := neorpc.GetRaftState(conf.Endpoint)
	ErrorOK(err)
	status.State = state
	status.Nodes = nodes

	rsp, err := neorpc.GetNodesRPC(conf.Endpoint)
	ErrorOK(err)
...
func raftEnablePurgeBinlogCommandFn(cmd *cobra.Command, args []string) {
	...
	// send enable
	{
		...
		err = neorpc.RaftEnablePurgeBinlogRPC(self)
		ErrorOK(err)
...
func raftDisablePurgeBinlogCommandFn(cmd *cobra.Command, args []string) {
	...
	// send enable
	{
		...
		err = neorpc.RaftDisablePurgeBinlogRPC(self)
		ErrorOK(err)
...
func raftEnableCheckSemiSyncCommandFn(cmd *cobra.Command, args []string) {
	...
	// send enable
	{
		...
		err = neorpc.RaftEnableCheckSemiSyncRPC(self)
		ErrorOK(err)
...
func raftDisableCheckSemiSyncCommandFn(cmd *cobra.Command, args []string) {
	...
	// send enable
	{
		...
		err = neorpc.RaftDisableCheckSemiSyncRPC(self)
		ErrorOK(err)
